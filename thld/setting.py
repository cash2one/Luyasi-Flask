...
if DEBUG:
    ...
    KINORSI_SERVER_NAME = 'qythld.com'
    KINORSI_SERVER_PORT = None
...
MAIL_DEFAULT_SENDER = "admin@qythld.com"
MAIL_SERVER = 'smtp.qq.com'
MAIL_PORT = 465
MAIL_USE_TLS = False
MAIL_USE_SSL = True
MAIL_USERNAME = 'admin@qythld.com'
...
# flask-security各类邮件头
SECURITY_EMAIL_SUBJECT_REGISTER = '感谢您注册qythld.com(清远天湖郦都)账号'
SECURITY_EMAIL_SUBJECT_PASSWORDLESS = '你使用了qythld.com(清远天湖郦都)无密码登陆方式'
SECURITY_EMAIL_SUBJECT_PASSWORD_NOTICE = '您的qythld.com(清远天湖郦都)通行证已经成功重置'
SECURITY_EMAIL_SUBJECT_PASSWORD_RESET = '请验证您的qythld.com(清远天湖郦都)通行证密码重置'
SECURITY_EMAIL_SUBJECT_PASSWORD_CHANGE_NOTICE = '您的qythld.com(清远天湖郦都))通行证密码修改成功'
SECURITY_EMAIL_SUBJECT_CONFIRM = '请验证qythld.com(清远天湖郦都)注册'
